...
import com.FlashScreen.flashservice.InnnerClass.MyServices;
...
public class MyAdapters extends BaseAdapter //implements Filterable
{
    ...
    public MyAdapters(Context ctx, ArrayList<Player> players) {
    ...
    public View getView(final int pos, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                Intent i = new Intent(c,MyServices.class);
