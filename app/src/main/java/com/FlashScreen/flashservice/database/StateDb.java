 ...
 */
public class StateDb extends SQLiteOpenHelper
{
    public static final String tableName = "StateDb";
    static String DATABASE_NAME="StateTable";
    public static final String KEY_ID="id";
    public static String col1 = "STATEID";
    public static String col2 = "STATE_NAME";


    public StateDb(Context _cntxt)
    {
        ...
        public String getName(String id)
        {
            ...
            String selectQuery = "SELECT * FROM "+ tableName+" WHERE STATEID ="+id;
        ...
        public String getId(String id)
        {
            ...
            String selectQuery = "SELECT * FROM "+ tableName+" WHERE STATE_NAME ="+id;
